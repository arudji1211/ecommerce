...
type TransactionService interface {
	...
	GetAll(ctx context.Context, db *gorm.DB, UserID uint) (TransactionOut []MDtransaction.Transaction, err error)
	Create(ctx context.Context, db *gorm.DB, ID uint, TransactionIn MDtransaction.Transaction) (MDtransaction.Transaction, error)
